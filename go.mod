...
require (
	github.com/DataDog/dd-trace-go/contrib/database/sql/v2 v2.11.0-dev.0.20260703080544-6b801cd948a9
	github.com/DataDog/dd-trace-go/contrib/google.golang.org/grpc/v2 v2.11.0-dev.0.20260703080544-6b801cd948a9
	github.com/DataDog/dd-trace-go/contrib/gorilla/mux/v2 v2.11.0-dev.0.20260703080544-6b801cd948a9
	github.com/DataDog/dd-trace-go/contrib/net/http/v2 v2.11.0-dev.0.20260703080544-6b801cd948a9
