...
require (
	...
	github.com/DataDog/dd-trace-go/v2/contrib/database/sql v0.0.0-20240223105017-0206562b3b5d
	github.com/DataDog/dd-trace-go/v2/contrib/gorilla/mux v0.0.0-20240223105017-0206562b3b5d
