...
require (
	...
	gopkg.in/DataDog/dd-trace-go.v1 v1.39.0-alpha.1.0.20231128090053-c6cb0bd7a10a
)
...
require (
	...
	github.com/DataDog/go-libddwaf/v2 v2.2.2-0.20231128085439-09f973f9b846 // indirect
