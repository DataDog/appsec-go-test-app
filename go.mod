...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.64.0-devel // indirect
	github.com/DataDog/datadog-agent/pkg/proto v0.64.0-devel // indirect
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.64.0-devel // indirect
	...
	github.com/DataDog/datadog-agent/pkg/util/scrubber v0.64.0-devel // indirect
	github.com/DataDog/datadog-agent/pkg/version v0.64.0-devel // indirect
